<div>
  ...
  <div id="sidebar" class=" bg-white border-r border-gray-300 h-full flex flex-col absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 h-screen overflow-y-scroll lg:overflow-y-auto no-scrollbar w-64 lg:w-20 lg:sidebar-expanded:!w-64 2xl:!w-64 shrink-0 bg-white p-4 transition-all duration-200 ease-in-out" :class="sidebarOpen ? 'translate-x-0' : '-translate-x-64'" @click.outside="sidebarOpen = false" @keydown.escape.window="sidebarOpen = false" x-cloak="lg">
   ...
   <div class="space-y-8 mb-10">
    <div>
      <ul class="mt-3">
        <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 @if(Request::segment(1) == 'dashboard'){{ 'text-[#416D14]' }}@endif">
          <a class="block @if(Request::segment(1) == 'dashboard'){{ 'text-[#416D14]' }}@else{{ 'text-gray-500' }}@endif text-lg truncate transition duration-150 focus:text-slate-200 focus:outline-none @if(Request::segment(1) == 'dashboard'){{ 'hover:text-green-500' }}@endif" href="{{ route('dashboard') }}">
      ...
      <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 @if(Request::segment(3) == 'daftar-farmer'){{ 'text-[#416D14]' }}@endif">
