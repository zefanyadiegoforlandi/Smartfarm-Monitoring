        ...
        <div class="bg-white border-transparent rounded-lg shadow-xl">
            ...
            <div class="p-5">
                ...
                <script>
                    ...
                    const suhu = tableData.map(entry => entry.intensitas_cahaya);
    ...
    <table class="w-full  mt-5">
        <thead class="bg-[#ECF0E8]">
            <tr>
                ...
                <th class="hidden md:table-cell p-2 text-[#416D14] uppercase">Intensitas Cahaya</th>

            </tr>
        </thead>
        <tbody>
            @foreach ($dataSensor as $i_cahaya)
            <tr class="text-center">
                <td class="p-2">{{ \Carbon\Carbon::parse($i_cahaya->waktu_perekaman)->format('H:i:s') }}</td>
                <td class="p-2">{{ \Carbon\Carbon::parse($i_cahaya->waktu_perekaman)->format('Y-m-d') }}</td>
                <td class="p-2">L007</td>
                <td class=" p-2">{{ $i_cahaya->intensitas_cahaya }} Cd</td>
            </tr>
            @endforeach
