...
<div class="min-w-full px-4 mb-5">
    ...
    <div class="items-center justify-between mt-5 flex">
        <div class="flex items-center justify-start">
            <p class="font-semibold text-3xl md:text-[40px] text-[#416D14]">Tekanan Udara</p>
        </div>
        ...
        <div class="bg-white border-transparent rounded-lg shadow-xl">
            ...
            <div class="p-5">
                ...
                <script>
                    ...
                    const tekanan_udara = tableData.map(entry => entry.tekanan);
    ...
    <table class="w-full  mt-5">
        ...
        <tbody>
            @foreach ($dataSensor as $t_udara)
            <tr class="text-center">
                <td class="p-2">{{ \Carbon\Carbon::parse($t_udara->waktu_perekaman)->format('H:i:s') }}</td>
                <td class="p-2">{{ \Carbon\Carbon::parse($t_udara->waktu_perekaman)->format('Y-m-d') }}</td>
                <td class="p-2">L007</td>
                <td class=" p-2">{{ $t_udara->tekanan_udara }} C</td>
            </tr>
            @endforeach
