...
<div class="min-w-full px-4 mb-5">
    ...
    <div class="items-center justify-between mt-5 flex">
        <div class="flex items-center justify-start">
            <p class="font-semibold text-3xl md:text-[40px] text-[#416D14]">Ketinggian</p>
        </div>
        ...
        <div class="bg-white border-transparent rounded-lg shadow-xl">
            ...
            <div class="p-5">
                ...
                <script>
                    ...
                    const suhu = tableData.map(entry => entry.ketinggian);
    ...
    <table class="w-full  mt-5">
        <thead class="bg-[#ECF0E8]">
            <tr>
                ...
                <th class="hidden md:table-cell p-2 text-[#416D14] uppercase">Ketinggian</th>
            </tr>
        </thead>
        <tbody>
            @foreach ($dataSensor as $kl)
